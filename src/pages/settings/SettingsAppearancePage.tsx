...
const SettingsAppearancePage = () => {
  ...
  const handleThemeChange = (newTheme: string) => {
    ...
    if ((newTheme === 'dark' && !theme?.darkMode) || (newTheme === 'light' && theme?.darkMode)) {
  ...
  useEffect(() => {
    if (theme) {
      setSelectedTheme(theme.darkMode ? 'dark' : 'light')
    }
  }, [theme?.darkMode])
        ...
        <div>
          ...
          <div className="flex gap-4 py-2">
            <div className="flex flex-col items-center">
              ...
              >
                <div className="p-2 w-full h-full bg-secondary-background rounded-md shadow-md dark:shadow-zinc-900 flex flex-col gap-2">
            ...
            <div className="flex flex-col items-center ">
              ...
              >
                <div className="p-2 w-full h-full bg-secondary-background-dark rounded-md shadow-md dark:shadow-zinc-900 flex flex-col gap-2">
