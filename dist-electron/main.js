...
import electron, { app as app$1, BrowserWindow, globalShortcut, shell as shell$1, ipcMain as ipcMain$1 } from "electron";
...
ipcMain$1.handle("getSettings", (_, key) => {
  return key ? store.get(key) : store.store;
});
ipcMain$1.handle("setSettings", (_, key, value) => {
  store.set(key, value);
  return true;
});
ipcMain$1.handle("resetSettings", () => {
  store.clear();
  return true;
});
export {
